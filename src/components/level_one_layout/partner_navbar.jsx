...
const PartnerNavbar = () => {
  ...
  useEffect(() => {
    const fetchPartnerData = async () => {
      try {
        ...
        if (data.partners) {
          setPartner(data.partners);  // Update state with Partner data directly
        }
      } catch (error) {
  ...
  const profileRoute = `/dashboard/profile/${partner?.username}`;
  const editProfileRoute = `/dashboard/edit`;
  ...
  return (
    // <div className="sticky top-0 drop-shadow-sm">
    //   <div className="flex justify-between items-center bg-white shadow md:px-12 py-[10px] px-4">
    <div className="sticky top-0 drop-shadow-sm z-[10]">
      <div className="flex justify-between items-center bg-white shadow md:px-12 py-[10px] px-4">
          ...
          <div className="flex items-center w-full justify-end lg:justify-between gap-5">
            ...
            <div className="flex items-center gap-3 md:gap-5">
              ...
              <Link href="/">
                <button
                  type="submit"
                  className={`text-gray-800 flex justify-center gap-2 items-center mx-auto lg:font-semibold isolation-auto ${
                    isMobile
                      ? ""
                ...
                >
                  {!isMobile && <span>Switch to User</span>}
                  <svg
                    className={`w-7 h-7 ${
                      isMobile ? "mx-auto" : ""
              ...
              <div className="flex items-center gap-4 ml-2 md:ml-4" onClick={toggleProfile} >
                <div>
                  <img
      ...
      {/* Dropdown Menu */}
      {menuOpen && (
        <div className="bg-white shadow-lg p-4 w-[200px] absolute z-5 h-screen flex flex-col">
          ...
          <nav className="flex flex-col justify-between">
            <ul>
              ...
              <Link href="/dashboard">
              <li
                onClick={() => handleActiveItem("my listings")}
              ...
              <li
                onClick={() => {
                  handleActiveItem("team settings")
                  toast.info('Feature Under Development! Stay tuned for updates.', {
                    position: "top-center",
                    autoClose: 5000,
                    hideProgressBar: false,
