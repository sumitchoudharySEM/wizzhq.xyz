...
import PaymentModal from "@/components/level_three_layout/payment_modal";
...
export default function BountyLayout({
  ...
  const handleTabClick = (tab: string) => {
    ...
    const basePath = isDashboard ? "/dashboard/bounties" : "/bounties";
      ...
      <>
        {pathname.split("/").includes("dashboard") && (
          <>
            {verified == 0 && (
              <div className="redstip bg-red-500 text-white py-4 px-5 md:px-14 md:py-6 flex flex-col md:flex-row justify-between">
                <div className="textt max-w-full md:max-w-2/3">
                  Hey, your bounty has not been verified yet. <br />
            ...
            {/* Edit Section - Shown for both verified and unverified bounties in dashboard */}
            <div
              className={`${
                verified === 0
            ...
            >
              ...
              <Link
                href={{
                  pathname: "/dashboard/create_listing/bounty",
              ...
              >
                ...
                >
                  ...
                  {verified === 0 ? "Edit Bounty" : "Editing Disabled"}
                </button>
              </Link>
            </div>
